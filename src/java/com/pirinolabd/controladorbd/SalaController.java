...
import com.pirinolabd.modelobd.Sala;
import com.pirinolabd.controladorbd.util.JsfUtil;
import com.pirinolabd.controladorbd.util.JsfUtil.PersistAction;
...
public class SalaController implements Serializable {
    ...
    @EJB
    private com.pirinolabd.controladorbd.SalaFacade ejbFacade;
    ...
    public static class SalaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sala) {
                Sala o = (Sala) object;
                return getStringKey(o.getNumeroSala());
            } else {
